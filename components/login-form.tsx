        ...
        <CardContent className="space-y-6">
          ...
          >
            <Button
              variant="discord"
              size="lg"
              className="w-full group relative overflow-hidden rounded-xl py-6 text-lg font-semibold bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-500 hover:to-green-500 border-0"
              type="submit"
              disabled={isLoading}
            >
