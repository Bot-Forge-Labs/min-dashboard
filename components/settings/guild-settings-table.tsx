...
import type { GuildSettings } from "@/lib/types/database"
        ...
        {filteredSettings.length === 0 ? (
          <div className="text-center py-8">
            <p className="text-emerald-200/60 mb-2">
              {searchTerm ? "No guild settings found matching your search." : "No guild settings found."}
            </p>
            {!searchTerm && (
          ...
          <Table>
            <TableHeader>
              <TableRow className="border-emerald-400/20 hover:bg-white/5">
                ...
                <TableHead className="text-emerald-200">Staff Log Channel</TableHead>
                <TableHead className="text-emerald-200">Muted Role</TableHead>
                <TableHead className="text-emerald-200">Join/Leave Channel</TableHead>
                <TableHead className="text-emerald-200">Ticket Channel</TableHead>
                <TableHead className="text-emerald-200 text-right">Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filteredSettings.map((setting) => (
                <TableRow key={setting.guild_id} className="border-emerald-400/20 hover:bg-white/5">
                  <TableCell className="font-mono text-white">{setting.guild_id.toString()}</TableCell>
