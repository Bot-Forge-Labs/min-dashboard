        ...
        if (response.ok) {
          ...
          try {
            const testQuery = await fetch(
              `${supabaseUrl}/rest/v1/guilds?select=count`,
              {
                method: "HEAD",
                headers: {
                  apikey: supabaseKey,
        ...
        <CardContent className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-emerald-200/70 text-sm">
              Your dashboard is connected to Supabase and ready to display real
              data.
            </p>
          </div>
        </CardContent>
        ...
        <CardContent className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-red-200/70 text-sm mb-2">
              Your network or firewall is blocking access to Supabase.
            </p>
            <p className="text-red-200/60 text-xs mb-2">
              Error: {errorDetails}
            </p>
