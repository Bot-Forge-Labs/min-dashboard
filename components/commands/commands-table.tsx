...
const commandSubcommands: Record<
  string,
...
> = {
  ...
  announcement: [
    { name: "create", description: "Create a new announcement with embed" },
  ],
  giveaway: [
          ...
          <div className="text-center py-8">
            ...
            {!searchTerm && (
              <p className="text-sm text-emerald-300/40">
                Bot commands will appear here once they are registered.
              </p>
            )}
          </div>
        ) : (
                      ...
                      <div className="flex items-center justify-between p-4 hover:bg-white/5 cursor-pointer">
                        <div className="flex items-center gap-4 flex-1">
                          ...
                          <div className="text-emerald-200/80">
                            {command.usage_count.toLocaleString()} uses
                          </div>
                          <Badge
                            variant="outline"
                            className={
                          ...
                          <div className="text-emerald-200/80">
                            {command.last_used
                              ? new Date(command.last_used).toLocaleDateString()
                              : "Never"}
                          </div>
                        </div>
                        <DropdownMenu>
                    ...
                    {hasSubcommands && (
                      <CollapsibleContent>
                        <div className="border-t border-emerald-400/20 bg-white/5">
                          <div className="p-4">
                            <h4 className="text-sm font-medium text-emerald-200 mb-3">
                              Subcommands:
                            </h4>
                            <div className="space-y-2">
                              {commandSubcommands[command.name].map(
                                (subcommand) => (
                                  <div
                                    key={subcommand.name}
