...
import { MoreHorizontal, Search, Edit, Trash2, Loader2, RefreshCw, ChevronDown, ChevronRight } from "lucide-react"
...
// Mock subcommands data based on your bot code
const commandSubcommands: Record<string, Array<{ name: string; description: string }>> = {
  punish: [
    { name: "warning", description: "Warn a user" },
    { name: "ban", description: "Ban a user" },
    { name: "mute", description: "Mute a user" },
  ],
  announcement: [{ name: "create", description: "Create an announcement via modal" }],
  giveaway: [
    { name: "create", description: "Create a new giveaway" },
    { name: "delete", description: "Delete a giveaway" },
    { name: "view", description: "View giveaway details" },
  ],
  reactionrole: [
    { name: "create", description: "Create a new reaction role message" },
    { name: "delete", description: "Delete an existing reaction role" },
    { name: "edit", description: "Edit an existing reaction role" },
    { name: "view", description: "View existing reaction role details" },
